...
<!-- CUSTOMIZE: Replace these topic tables with your project's domains -->
<!-- after running /init, update these tables to match your PURPOSE.md -->

### Project Topics (→ DECISIONS.md)

| Topic | Scan For |
|-------|----------|
| `research` | Research findings, analysis, comparisons |
| `design` | Design decisions, architecture choices |
| `tools` | Tool selection, configuration, integration |
| `data` | Data sources, formats, processing |
| `output` | Deliverables, artifacts, publications |
...
Decisions about the project itself: architecture, design, tool selection, data handling.
...
| **Architecture choice** | How components relate, data flow design |
| **Code style/convention** | Naming patterns, file organization |
| **Technology selection** | Which tool, which format, which approach |
| **Breaking change** | Ordering that affects other phases |
