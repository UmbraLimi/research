...
├── Needs.md                            # Output for Claude Code (continuously updated)
│
...
- **User Stories:** `story-NNN-[2-4-word-description].md`
...
### Content guidelines
- Use lowercase for filenames (except STRUCTURE.md, Needs.md, PLAN.md)
...
### Needs.md
The evolving requirements document that will be handed to Claude Code. Contains:
...
3. **Iterative:** Needs.md evolves continuously, not written once
4. **Traceable:** Can always trace why decisions were made
5. **Handoff-ready:** Structure supports giving everything to Claude Code

## Current State

**Last session:** 2025-11-26-1
**Next technology number:** 001
**Next story number:** 001
**Next comparison number:** 001
**Next learning number:** 001
**Next decision number:** 001
